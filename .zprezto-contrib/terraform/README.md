# Terraform module for Prezto

[Terraform](https://github.com/hashicorp/terraform) module for the [Prezto](https://github.com/sorin-ionescu/prezto) Zsh configuration framework.
...
2. Clone this repository:
    ```
    git clone https://github.com/daviddesmet/zprezto-contrib-terraform.git ~/.zprezto-contrib/terraform
    ```
